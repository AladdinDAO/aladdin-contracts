...
contract StrategySushiETHUSDC is BaseStrategy {
    ...
    address constant public lpETHUSDC = address(0x397FF1542f962076d0BFE58eA045FfA2d347ACa0); // want
    ...
    uint256 constant public pidWant = 1;

    /* ========== CONSTRUCTOR ========== */

    constructor(address _controller)
      public
      BaseStrategy(_controller, lpETHUSDC, SUSHI)
    {
