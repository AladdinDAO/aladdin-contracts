...
contract StrategyCurveAave3Pool is BaseStrategy {
    ...
    address constant public a3CRV = address(0xFd2a8fA60Abd58Efe3EeE34dd494cD491dC14900); // want
    address constant public CRV = address(0xD533a949740bb3306d119CC777fa900bA034cd52); // reward
    address constant public gauge = address(0xd662908ADA2Ea1916B3318327A97eB18aD588b5d);
    ...
    constructor(address _controller)
      public
      BaseStrategy(_controller, a3CRV, CRV)
    {
