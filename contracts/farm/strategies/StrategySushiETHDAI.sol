...
contract StrategySushiETHDAI is BaseStrategy {
    ...
    address constant public lpETHDAI = address(0xC3D03e4F041Fd4cD388c549Ee2A29a9E5075882f); // want
    ...
    uint256 constant public pidWant = 2;

    /* ========== CONSTRUCTOR ========== */

    constructor(address _controller)
      public
      BaseStrategy(_controller, lpETHDAI, SUSHI)
    {
