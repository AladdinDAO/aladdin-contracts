...
contract TokenDistributor {
    ...
    function distribute() public {
        ...
        DAOFunding(dao).notifyRewardAmount(_daoAmount);
    ...
    function setTeamAllocation(address _teamAllocation) {
        require(msg.sender == governance, "!governance");
        teamAllocation = _teamAllocation;
    }

    function setDaoAllocation(address _daoAllocation) {
        require(msg.sender == governance, "!governance");
